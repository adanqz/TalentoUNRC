  ...
  return (
    <div className="bg-slate-50/50">
      <section className="relative w-full border-b bg-slate-50 py-20 md:py-24 lg:py-32">
        <Image
          src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxwcm9mZXNzaW9uYWxzJTIwd29ya2luZ3xlbnwwfHx8fDE3NjE1NjYxMTd8MA&ixlib=rb-4.1.0&q=80&w=1080"
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6">
            ...
            <div className="mt-8 mx-auto max-w-4xl rounded-lg border bg-card p-6 shadow-sm">
