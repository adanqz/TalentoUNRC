...
export const opportunities: Opportunity[] = [
  ...
  {
    id: 'opp-8',
    title: 'Desarrollador de Videojuegos (Pasantía)',
  ...
  {
    id: 'opp-10',
    title: 'Pasantía de Desarrollador Full-Stack',
    businessName: 'Innovatech',
    businessId: 'biz-4',
    businessLogoUrl: getImage('business-logo-4'),
    type: 'Pasantía',
    description: 'Trabaja en el frontend y backend de nuestras aplicaciones SaaS.',
    longDescription: 'Buscamos un pasante versátil que se sienta cómodo trabajando con tecnologías tanto del lado del cliente como del lado del servidor. Nuestra pila tecnológica incluye React, Node.js, Python y AWS. Es una gran oportunidad para convertirse en un desarrollador completo.',
    location: 'Remoto',
